...
<head>
    ...
    <title>Edit Agenda | Admin GOW</title>
    ...
    <div class="main-content">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white py-3">
                <h6 class="m-0 fw-bold">Form Edit Agenda</h6>
            </div>
                ...
                <form action="<?= base_url('admin/agenda/update/' . $agenda['slug']) ?>" method="POST"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="deskripsi"
                            class="form-control"><?= htmlspecialchars($agenda['deskripsi']) ?></textarea>
                    </div>

                    <div class="mb-4">
                        <label class="form-label fw-semibold">Ganti Flyer/Gambar</label>
                        ...
                        <?php if ($agenda['gambar']): ?>
                            <div class="mt-2 p-2 border rounded bg-light d-inline-block">
                                ...
                                <img src="<?= base_url('uploads/' . $agenda['gambar']) ?>" alt="Current Image"
                                    style="height: 80px;">
                            </div>
                        <?php endif; ?>

                        <small class="d-block text-muted mt-1">Biarkan kosong jika tidak ingin mengubah gambar.</small>
                    </div>
