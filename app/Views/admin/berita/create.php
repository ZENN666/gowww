...
<head>
    ...
    <title>Tambah Berita | Admin GOW</title>
    ...
    <div class="main-content">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white py-3">
                <h6 class="m-0 fw-bold">Form Tambah Berita</h6>
            </div>
            <div class="card-body p-4">
                ...
                <form method="POST" action="<?= BASE_PATH ?>/admin/berita/store" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            <label for="thumbnail" class="form-label fw-semibold">Gambar Utama</label>
                            <input type="file" class="form-control" id="thumbnail" name="thumbnail">
                            <small class="text-muted d-block mt-1" style="font-size: 12px;">Format: JPG/PNG, Max:
                                2MB</small>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" id="content" name="content"
                            placeholder="Tulis isi berita lengkap di sini..." required></textarea>
                    </div>
